...
if orden == False:
    ...
    y = ODE.theta( pendulo, y0, tf/nt, nt, th = 0. )
    ...
    y = ODE.theta( pendulo, y0, tf/nt, nt, th = 1. )
    ...
    y = ODE.theta( pendulo, y0, tf/nt, nt, th = 0.5 )
    ...
    for i, nt in enumerate(tlist):
        ...
        y = ODE.theta( pendulo, y0, tf/int(nt), int(nt), th = 0. )
        ...
        y = ODE.theta( pendulo, y0, tf/int(nt), int(nt), th = 1. )
        ...
        y = ODE.theta( pendulo, y0, tf/int(nt), int(nt), th = 0.5 )
        ...
        y = ODE.RK4( pendulo, y0, tf/int(nt), int(nt) )
    ...
    axs[0].loglog( tf / tlist, (tf / tlist)**4, label = r'$O(h^4)$', linestyle = '-.', color = 'k')
